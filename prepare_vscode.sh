...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  ...
  setpath "product" "nameShort" "CodeN'Co Studio"
  setpath "product" "nameLong" "CodeN'Co Studio"
  setpath "product" "applicationName" "codium"
  setpath "product" "linuxIconName" "vscodium"
  setpath "product" "quality" "stable"
  setpath "product" "urlProtocol" "codenco-studio"
  setpath "product" "serverApplicationName" "codenco-server"
  setpath "product" "serverDataFolderName" ".codenco-studio-server"
  setpath "product" "dataFolderName" ".codenco-studio"
  setpath "product" "darwinBundleIdentifier" "io.codenco.studio"
  setpath "product" "win32AppUserModelId" "CodeNCo.Studio"
  setpath "product" "win32DirName" "CodeN'Co Studio"
  setpath "product" "win32MutexName" "codencostudio"
  setpath "product" "win32NameVersion" "CodeN'Co Studio"
  setpath "product" "win32RegValueName" "CodeNCoStudio"
  setpath "product" "win32ShellNameShort" "CodeN'Co Studio"
  setpath "product" "win32AppId" "{{8F2A7C13-4B9E-4D6A-A1F2-3E5C8B7D9011}"
  setpath "product" "win32x64AppId" "{{C4D9E1F6-2A3B-4C7D-9E8F-1B2A3C4D5E60}"
  setpath "product" "win32arm64AppId" "{{A1B2C3D4-5E6F-4708-9A1B-2C3D4E5F6071}"
  setpath "product" "win32UserAppId" "{{7E8F9A0B-1C2D-4E3F-8A9B-0C1D2E3F4082}"
  setpath "product" "win32x64UserAppId" "{{9B0C1D2E-3F4A-4B5C-8D6E-7F8A9B0C1D23}"
  setpath "product" "win32arm64UserAppId" "{{2D3E4F5A-6B7C-4D8E-9F0A-1B2C3D4E5F34}"
  setpath "product" "tunnelApplicationName" "codenco-tunnel"
  setpath "product" "win32TunnelServiceMutex" "codenco-tunnelservice"
  setpath "product" "win32TunnelMutex" "codenco-tunnel"
