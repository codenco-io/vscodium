...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  ...
  setpath "product" "nameShort" "CodeNCo Studio"
  ...
  setpath "product" "win32DirName" "CodeNCo Studio"
  setpath "product" "win32MutexName" "codencostudio"
  setpath "product" "win32NameVersion" "CodeNCo Studio"
  setpath "product" "win32RegValueName" "CodeNCoStudio"
  setpath "product" "win32ShellNameShort" "CodeNCo Studio"
